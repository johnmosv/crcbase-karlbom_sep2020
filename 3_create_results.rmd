...
# ad %>% select(lopnr, case, end_of_study, deathdate, migrationdate, sbo_patreg_date,
# relapse_date, sbo_surgery_patreg_date2, sbo_eof, sbo_surgery_eof2)
...
survminer::ggcompetingrisks(cif_sbo, multiple_panels = F) +
    ...
    scale_x_continuous(name = "Months", breaks = c(0, 18, 41, 66, 125)) +
    theme(

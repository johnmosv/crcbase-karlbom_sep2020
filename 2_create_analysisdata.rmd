...
#### SCRCR only
_called exposure variables in the analysis plan_
...
# Add to population TODO if it should be assessed this way
...
stoma_closures <- surgeries_raw[code %in% definitions$procedure_codes[["stoma_closure"]], .(
